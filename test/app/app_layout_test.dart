...
void main() {
    ...
    MaterialApp.router(
      ...
      routerConfig: Routefly.routerConfig(
        ...
        routeBuilder: (context, settings, child) => PageRouteBuilder(
          settings: settings,
          pageBuilder: (context, __, ___) => const SizedBox(height: 500, child: AppPage()),
        ),
      ),
    ),
  ...
  zGoldenTest(
    "When the device size is a mobile, it should have a bottom navbar instead of a top app bar",
    goldenFileName: "app_layout_navbar",
    (tester) async {
  ...
  zGoldenTest(
    "When the device size is a desktop, it should have a top app bar to navigate, instead of a bottom navbar",
    goldenFileName: "app_layout_top_app_bar",
    (tester) async {
      await tester.pumpDeviceBuilder(
        await goldenBuilder(isMobile: false),
  ...
  zGoldenTest(
    "When scrolling down, it should have a footer (desktop version)",
    goldenFileName: "app_layout_footer_desktop",
    (tester) async {
  ...
  zGoldenTest(
    "When scrolling down, it should have a footer (mobile version)",
    goldenFileName: "app_layout_footer_mobile",
    (tester) async {
      await tester.pumpDeviceBuilder(await goldenBuilder(isMobile: true), wrapper: GoldenConfig.localizationsWrapper());
