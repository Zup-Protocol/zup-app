...
void main() {
  ...
  Future<DeviceBuilder> goldenBuilder({void Function()? onAccept}) async => await goldenDeviceBuilder(
        Center(
  ...
  zGoldenTest(
    "When clicking in the privacy policy button, it should launch the privacy policy",
    (tester) async {
  ...
  zGoldenTest("When clicking in the understood button, it should callback", (tester) async {
    ...
    await tester.pumpDeviceBuilder(await goldenBuilder(onAccept: () {
      hasCalled = true;
    }));
