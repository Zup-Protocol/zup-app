...
void main() {
  ...
  setUp(() {
    ...
    sut = AppCache(sharedPreferencesWithCache);
  });
  ...
  test(
    ...
    () async {
      ...
      verify(() => sharedPreferencesWithCache.setBool(AppCacheKey.hidingClosedPositions.key, status)).called(1);
    },
  );
  ...
  test(
    ...
    () async {
      ...
      verify(() => sharedPreferencesWithCache.getBool(AppCacheKey.hidingClosedPositions.key)).called(1);
    },
  );
  ...
  test("When calling `saveDepositSettings` it should use the correct key to store the deposit settings", () async {
    ...
    verify(() => sharedPreferencesWithCache.setString(AppCacheKey.depositSettingsV2.key, any())).called(1);
  });
  ...
  test("When calling `getDepositSettings` it should use the correct key to get the deposit settings", () async {
    ...
    verify(() => sharedPreferencesWithCache.getString(AppCacheKey.depositSettingsV2.key)).called(1);
  });
  ...
  test("When calling '.keys' in the cache key enum, it should return all the cache keys as Set", () {
    expect(AppCacheKey.keys, AppCacheKey.values.map((e) => e.key).toSet());
  });
  ...
  test("when calling `saveTestnetMode` it should save under the correct key", () async {
    ...
    verify(() => sharedPreferencesWithCache.setBool(AppCacheKey.isTestnetMode.key, isTestnetMode)).called(1);
  });
  ...
  test("when calling `getTestnetMode` it should get under the correct key", () async {
    ...
    verify(() => sharedPreferencesWithCache.getBool(AppCacheKey.isTestnetMode.key)).called(1);
  });
  ...
  test("when calling 'savePoolSearchSettings' it should save under the correct key", () {
    ...
    verify(
      () => sharedPreferencesWithCache.setString(AppCacheKey.poolSearchSettings.key, jsonEncode(settings.toJson())),
    ).called(1);
  });
  ...
  test("when calling 'getPoolSearchSettings' it should get under the correct key", () {
    ...
    verify(() => sharedPreferencesWithCache.getString(AppCacheKey.poolSearchSettings.key)).called(1);
  });
  ...
  test("when calling 'saveCookiesConsentStatus' it should save under the correct key", () {
    ...
    verify(() => sharedPreferencesWithCache.setBool(AppCacheKey.areCookiesConsented.key, status)).called(1);
  });
  ...
  test("when calling 'getCookiesConsentStatus' it should get under the correct key", () {
    ...
    expect(result, true);
    verify(() => sharedPreferencesWithCache.getBool(AppCacheKey.areCookiesConsented.key)).called(1);
  });
  ...
  test("when calling 'blockedProtocolsIds' it should get under the correct key", () {
    ...
    expect(result, ["1", "2"]);
    verify(() => sharedPreferencesWithCache.getStringList(AppCacheKey.blockedProtocolsIds.key)).called(1);
  });
  ...
  test("when calling 'saveBlockedProtocolsIds' it should save under the correct key", () async {
    ...
    verify(() => sharedPreferencesWithCache.setStringList(AppCacheKey.blockedProtocolsIds.key, ids)).called(1);
  });
}
