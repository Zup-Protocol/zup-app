...
void main() {
  test(
    "When calling 'poolsSortedBy24hYield' it should short pools descending by 24h yield removing pools with 0 yield for 24h",
    () {
      final pools = [
      ...
      expect(
        ...
        pools.sorted((a, b) => b.yield24h.compareTo(a.yield24h)).where((a) => a.yield24h != 0),
      );
    },
  );

  test(
    "When calling 'poolsSortedBy7dYield' it should short pools descending by 7d yield removing pools with 0 yield for 7d",
    () {
      final pools = [
      ...
      expect(
        ...
        pools.sorted((a, b) => b.yield7d.compareTo(a.yield7d)).where((a) => a.yield7d != 0),
      );
    },
  );

  test(
    "When calling 'poolsSortedBy30dYield' it should short pools descending by 30d yield removing pools with 0 yield for 30d",
    () {
      final pools = [
      ...
      expect(
        ...
        pools.sorted((a, b) => b.yield30d.compareTo(a.yield30d)).where((a) => a.yield30d != 0),
      );
    },
  );

  test(
    "When calling 'poolsSortedBy90dYield' it should short pools descending by 90d yield removing pools with 0 yield for 90d",
    () {
      final pools = [
      ...
      expect(
        ...
        pools.sorted((a, b) => b.yield90d.compareTo(a.yield90d)).where((a) => a.yield90d != 0),
      );
    },
  );
