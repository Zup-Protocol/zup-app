  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: ZupColors.gray5, width: 1),
      ),
      child: Padding(
          ...
          children: [
                ...
                CupertinoSlidingSegmentedControl(
                  ...
                  children: {
                    Slippage.zeroPointOnePercent: const MouseRegion(
                      ...
                      child: IgnorePointer(child: Text("0.1%", style: TextStyle(fontWeight: FontWeight.w600))),
                    ),
                    Slippage.halfPercent: const MouseRegion(
                      key: Key("zero-point-five-percent-slippage"),
                      cursor: SystemMouseCursors.click,
                      child: IgnorePointer(child: Text("0.5%", style: TextStyle(fontWeight: FontWeight.w600))),
                    ),
                    Slippage.onePercent: const MouseRegion(
                      key: Key("one-percent-slippage"),
                      cursor: SystemMouseCursors.click,
                      child: IgnorePointer(child: Text("1%", style: TextStyle(fontWeight: FontWeight.w600))),
                    ),
                  },
            ...
            AnimatedContainer(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Assets.icons.exclamationmarkTriangle
                      .svg(colorFilter: const ColorFilter.mode(ZupColors.orange, BlendMode.srcIn)),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Text.rich(
                      TextSpan(children: [
                                ...
                                child: IgnorePointer(
                                  child: Text(
                                    ...
                                    style: const TextStyle(
                                      fontSize: 14,
                                      color: ZupColors.orange,
                                      fontWeight: FontWeight.bold,
                                      decoration: TextDecoration.underline,
                                      decorationColor: ZupColors.orange,
                                    ),
                                  ),
                                ),
                              ),
                    ...
                    child: SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          counterText: "",
                          error:
                              (int.tryParse(deadlineTextController.text) ?? 0) > 1200 ? const SizedBox.shrink() : null,
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(8),
                            borderSide: const BorderSide(color: ZupColors.gray5),
                          ),
